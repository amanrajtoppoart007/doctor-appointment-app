...
const PriceUpdateModel = ({price, visible, hideModal, onPriceUpdate}) => {
  const [doctorPrice, setDoctorPrice] = useState(price);
  ...
  return (
    <Modal visible={visible} onDismiss={hideModal}>
      <View style={styles.modalView}>
        ...
        <Text style={styles.hint}>Enter New Price</Text>
        ...
        <TouchableOpacity
          disabled={!doctorPrice || parseInt(doctorPrice) <= 0}
          onPress={() => onPriceUpdate(doctorPrice)}
          style={styles.button}>
...
export default PriceUpdateModel;
